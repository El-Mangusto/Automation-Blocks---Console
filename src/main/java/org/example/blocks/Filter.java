...
public class Filter extends ActionBlock {
    ...
    public void execute() {
        ...
        for (String item : (List<String>) inputVar.getValue()) {
            if (item == null) {
                continue;
            }
        ...
        ExecutionContext.setVariable(outputVarName, VariableType.LIST_STRING, filtered);
    ...
    public List<String> getConfigKeys() {
        return List.of("filter", "inputVarName", "outputVarName");
    }
